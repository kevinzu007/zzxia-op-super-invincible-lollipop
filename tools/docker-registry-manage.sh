...
F_GET_REPO_TAG_DIGEST_AND_TAGBLOB_DIGEST()
{
    ...
    F_REPO_TAG=$2
    F_REPO_NAME_SED=${F_REPO_NAME//\//_}
    F_GET_REPO_TAG_HEAD_FILE="${LOG_HOME}/F_GET_REPO_TAG_DIGEST_AND_TAGBLOB_DIGEST-head.txt--${F_REPO_NAME_SED}"
    F_GET_REPO_TAG_BODY_FILE="${LOG_HOME}/F_GET_REPO_TAG_DIGEST_AND_TAGBLOB_DIGEST-body.txt--${F_REPO_NAME_SED}"
