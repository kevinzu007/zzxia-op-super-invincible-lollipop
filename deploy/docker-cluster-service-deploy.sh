...
F_HELP()
{
    ...
    示例：
        ...
        # 服务名称正则匹配（需完全匹配，可以匹配多个），下面示例中的【服务1】、【服务2】皆可为正则表达式
        ...
        $0 -c  -G           服务1 服务2  -F          #--- 创建【服务1】、【服务2】的灰度服务，灰度版本号为默认版本号
        $0 -c  -G  -V yyy   服务1 服务2  -F          #--- 创建【服务1】、【服务2】的灰度服务，灰度版本号为【yyy】
        # 修改（服务名不能是灰度服务名）
        $0 -m  -F                                    #--- 根据服务清单修改所有服务
...
sed  -i  -E  -e '/^\s*$/d'  -e '/^##.*$/d'  -e '/---/d'  -e '/^#.*PRIORITY/d'  ${SERVICE_LIST_FILE_TMP}
# 优先级排序
